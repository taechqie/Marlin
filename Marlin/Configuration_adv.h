 ...
 */
  ...
  #define THERMAL_PROTECTION_HYSTERESIS 18 //4     // Degrees Celsius
...
//#define EXTRUDER_RUNOUT_PREVENT#endif
...
#define HOMING_BUMP_MM      { 6, 6, 1 }       // (linear=mm, rotational=°) Backoff from endstops after first bump
